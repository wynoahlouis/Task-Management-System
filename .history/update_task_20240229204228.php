        ...
        if(isset($_GET['id']))
        {
            ...
            <input type="hidden" name="id" value="<?=$user['id'];?>">
                ...
                <div class="row">
                    ...
                    <form method="POST" action="process.php" style="display: flex; justify-content: end">
                        <input type="hidden" name="id" value="<?=$user['id'];?>">
                        <a href="view_task.php" class="btn btn-secondary" style="margin-right: 20px; border-radius: 20px; width: 30%;">Cancel</a>
                        <button type="submit" class="btn btn-danger" name="updateButton" style="border-radius: 20px; width: 30%">Update</button>
                     </form>
                </div>
            </form>
        </div>
