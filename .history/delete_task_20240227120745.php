            ...
            <input type="hidden" name="id" value="<?=$user['id'];?>">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3 text-center">
                        <!-- Modify the delete button to include a confirmation -->
                        <button type="submit" class="btn btn-danger" name="deleteButton" onclick="return confirm('Are you sure you want to delete this task?');">Delete</button>
