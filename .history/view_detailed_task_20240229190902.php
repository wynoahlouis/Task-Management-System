        ...
        <div class="row justify-content-center">
            ...
            ?>
                ...
                <div class="row">
                    ...
                    <a href="view_task.php" type="button" class="btn btn-secondary" style="margin-right: 20px; border-radius: 20px; width:70%; align-content: center;" name="cancelButton">Go Back</a>
