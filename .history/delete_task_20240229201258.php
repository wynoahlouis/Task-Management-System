        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-md-12 mb-3" style="align-items: center;">
                    <label for="title" class="form-label" style="margin: 0; font-weight: 300">Task Title</label>
                    <p style="font-size:150%; font-weight: 200;  text-align: justify;"><?=$user['title'];?></p>
                </div>

                <div class="col-md-12 mb-3">
                    <label for="description" class="form-label" style="margin: 0; font-weight: 300">Description</label>
                    <p style="font-size:150%; font-weight: 200; text-align: justify;"><?=$user['description'];?></p>
                </div>

                <div class="col-md-6 mb-3">
                    <label for="priority" style="margin: 0; font-weight: 300">Priority Level</label>
                    <p style="font-size:150%; font-weight: 200; text-align: justify;"><?=$user['priority'];?></p>
                </div>

                <div class="col-md-6 mb-3">
                    <label for="due_date" class="form-label" style="margin: 0; font-weight: 300">Due Date</label>
